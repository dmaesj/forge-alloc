...
| `forge-alloc-capi` | C ABI for C/C++ — a hardened bump arena over a caller-provided buffer, for embedded users. `staticlib` for firmware, `cdylib` for desktop. See [`docs/C_API.md`](https://github.com/dmaesj/forge-alloc/blob/main/docs/C_API.md). (provisional `0.1.x` ABI) |
